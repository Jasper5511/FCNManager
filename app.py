...
# 2026-09-18：觸發 Render 重新部署以套用 2026SN5429 配息排程
with app.app_context():
    try:
        ...
        _SCHEDULES = {
            ...
            '2026SN3711': [
                (1, '2026-06-24', '2026-07-30', '2026-08-03'),
                (2, '2026-07-31', '2026-08-31', '2026-09-02'),
                (3, '2026-09-01', '2026-09-30', '2026-10-02'),
                (4, '2026-10-01', '2026-10-30', '2026-11-03'),
                (5, '2026-10-31', '2026-11-30', '2026-12-02'),
                (6, '2026-12-01', '2026-12-30', '2027-01-04'),
                (7, '2026-12-31', '2027-02-01', '2027-02-03'),
                (8, '2027-02-02', '2027-03-01', '2027-03-03'),
                (9, '2027-03-02', '2027-03-30', '2027-04-01'),
            ],
            '2026SN3154': [
            ...
            '2026SN4332': [
                (1, '2026-07-30', '2026-08-31', '2026-09-03'),
                (2, '2026-09-01', '2026-09-30', '2026-10-05'),
                (3, '2026-10-01', '2026-10-30', '2026-11-04'),
                (4, '2026-11-01', '2026-11-30', '2026-12-03'),
                (5, '2026-12-01', '2026-12-30', '2027-01-05'),
                (6, '2026-12-31', '2027-02-01', '2027-02-04'),
            ],
            '2026SN4421': [
                (1, '2026-08-07', '2026-09-08', '2026-09-10'),
                (2, '2026-09-09', '2026-10-06', '2026-10-08'),
                (3, '2026-10-07', '2026-11-06', '2026-11-10'),
                (4, '2026-11-09', '2026-12-07', '2026-12-09'),
                (5, '2026-12-08', '2027-01-06', '2027-01-08'),
                (6, '2027-01-07', '2027-02-08', '2027-02-10'),
            ],
            '2026SN4637': [
                (1, '2026-08-14', '2026-09-14', '2026-09-16'),
                (2, '2026-09-15', '2026-10-14', '2026-10-16'),
                (3, '2026-10-15', '2026-11-16', '2026-11-18'),
                (4, '2026-11-17', '2026-12-14', '2026-12-16'),
                (5, '2026-12-15', '2027-01-14', '2027-01-19'),
                (6, '2027-01-15', '2027-02-16', '2027-02-18'),
            ],
            '2026SN4697': [
                (1, None,         '2026-09-17', '2026-09-22'),
                (2, '2026-09-17', '2026-10-19', '2026-10-22'),
                (3, '2026-10-19', '2026-11-17', '2026-11-20'),
                (4, '2026-11-17', '2026-12-17', '2026-12-22'),
                (5, '2026-12-17', '2027-01-19', '2027-01-22'),
                (6, '2027-01-19', '2027-02-17', '2027-02-22'),
            ],
            '2026SN4953': [
                (1, '2026-08-20', '2026-09-28', '2026-09-30'),
                (2, '2026-09-29', '2026-10-26', '2026-10-28'),
                (3, '2026-10-27', '2026-11-27', '2026-12-01'),
                (4, '2026-11-28', '2026-12-28', '2026-12-30'),
                (5, '2026-12-29', '2027-01-26', '2027-01-28'),
                (6, '2027-01-27', '2027-02-26', '2027-03-02'),
                (7, '2027-02-27', '2027-03-29', '2027-03-31'),
                (8, '2027-03-30', '2027-04-26', '2027-04-28'),
                (9, '2027-04-27', '2027-05-26', '2027-05-28'),
            ],
            '2026SN5124': [
                (1, '2026-08-27', '2026-10-02', '2026-10-06'),
                (2, '2026-10-03', '2026-11-02', '2026-11-04'),
                (3, '2026-11-03', '2026-12-02', '2026-12-04'),
                (4, '2026-12-03', '2027-01-04', '2027-01-06'),
                (5, '2027-01-05', '2027-02-02', '2027-02-04'),
                (6, '2027-02-03', '2027-03-02', '2027-03-04'),
                (7, '2027-03-03', '2027-04-02', '2027-04-06'),
                (8, '2027-04-03', '2027-05-03', '2027-05-05'),
                (9, '2027-05-04', '2027-06-02', '2027-06-04'),
            ],
            '2026SN5185': [
                (1, '2026-09-05', '2026-10-14', '2026-10-19'),
                (2, '2026-10-15', '2026-11-16', '2026-11-19'),
                (3, '2026-11-17', '2026-12-14', '2026-12-17'),
                (4, '2026-12-15', '2027-01-14', '2027-01-20'),
                (5, '2027-01-15', '2027-02-16', '2027-02-19'),
                (6, '2027-02-17', '2027-03-15', '2027-03-18'),
            ],
            '2026SN5429': [
                (1, '2026-09-16', '2026-10-16', '2026-10-20'),
                (2, '2026-10-19', '2026-11-16', '2026-11-18'),
                (3, '2026-11-17', '2026-12-16', '2026-12-18'),
                (4, '2026-12-17', '2027-01-19', '2027-01-21'),
                (5, '2027-01-20', '2027-02-16', '2027-02-18'),
                (6, '2027-02-17', '2027-03-16', '2027-03-18'),
            ],
        }
